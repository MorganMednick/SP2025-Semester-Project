import { StubHubScrapingPayload, VividSeatsScrapingPayload } from '@client/types/shared/payloads';
...
export const getPriceForStubHubViaScraping = (
  payload: StubHubScrapingPayload,
...
export const getPriceForVividSeatsViaScraping = (
  payload: VividSeatsScrapingPayload,
): Promise<ApiResponse<ScrapingPriceResponse>> => {
